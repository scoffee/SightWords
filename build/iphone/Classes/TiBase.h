...
// in simulator we redefine to format for SightWords Developer console
...
{\
	NSString * exceptionName = [@"org.sightwords." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sightwords";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UISightWordsNativeItemNone = -1, 
	UISightWordsNativeItemSpinner = -2,
	UISightWordsNativeItemProgressBar = -3,
	
	UISightWordsNativeItemSlider = -4,
	UISightWordsNativeItemSwitch = -5,
	UISightWordsNativeItemMultiButton = -6,
	UISightWordsNativeItemSegmented = -7,
	
	UISightWordsNativeItemTextView = -8,
	UISightWordsNativeItemTextField = -9,
	UISightWordsNativeItemSearchBar = -10,
	
	UISightWordsNativeItemPicker = -11,
	UISightWordsNativeItemDatePicker = -12,
	
	UISightWordsNativeItemInfoLight = -13,
	UISightWordsNativeItemInfoDark = -14,
	
	UISightWordsNativeItemDisclosure = -15,
	
	UISightWordsNativeItemContactAdd = -16
};
